...
-- Schema My_Fitness
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `My_Fitness` DEFAULT CHARACTER SET utf8 ;
USE `My_Fitness` ;

-- -----------------------------------------------------
-- Table `My_Fitness`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `My_Fitness`.`user` (
...
-- -----------------------------------------------------
-- Table `My_Fitness`.`video`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `My_Fitness`.`video` (
...
-- -----------------------------------------------------
-- Table `My_Fitness`.`video_like`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `My_Fitness`.`video_like` (
  ...
  CONSTRAINT `fk_video_like_user`
    FOREIGN KEY (`user_id`)
    REFERENCES `My_Fitness`.`user` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_video_like_video1`
    FOREIGN KEY (`video_id`)
    REFERENCES `My_Fitness`.`video` (`video_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `My_Fitness`.`review`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `My_Fitness`.`review` (
...
-- -----------------------------------------------------
-- Table `My_Fitness`.`friend`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `My_Fitness`.`friend` (
...
-- -----------------------------------------------------
-- Table `My_Fitness`.`daily_workout`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `My_Fitness`.`daily_workout` (
